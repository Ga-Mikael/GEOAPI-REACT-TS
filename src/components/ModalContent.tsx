...
export default function ModalContent({country, closeModal}: IInfoCountry) {
    return (
        <div
            onClick={closeModal}
            ...
            <div
                ...
                <button
                    onClick={closeModal}
                    className="absolute top-2 right-1 w-8 h-8 flex items-center justify-center text-sm bg-red-600
